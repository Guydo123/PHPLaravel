...
<dl>
    <dt onclick="showItem('one'),hideItems('span','showanswer1')"><h3>Can I change the colours of the designs?</h3><span class="showanswer1"></span></dt>
    ...
    <dt onclick="showItem('two'),hideItems('span','showanswer1')"><h3>Can I order a certain animal to be designed by you?</h3><span class="showanswer1"></span></dt>
